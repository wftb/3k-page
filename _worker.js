...
let userID = '05153d24-5d01-421b-9632-994a4835cb22';

const พร็อกซีไอพีs = ['ProxyIP.US.fxxk.dedyn.io','ProxyIP.Oracle.fxxk.dedyn.io','us.cf.zhetengsha.eu.org','ProxyIP.Aliyun.fxxk.dedyn.io','us.ipdb.rr.nu'];

// if you want to use ipv6 or single พร็อกซีไอพี, please add comment at this line and remove comment at the next line
let พร็อกซีไอพี = พร็อกซีไอพีs[Math.floor(Math.random() * พร็อกซีไอพีs.length)];
// use single พร็อกซีไอพี instead of random
// let พร็อกซีไอพี = 'ProxyIP.US.fxxk.dedyn.io';
